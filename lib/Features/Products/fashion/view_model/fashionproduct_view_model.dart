...
class FashionProductViewModel extends ChangeNotifier {
  final FashionProductRepository _productRepository = FashionProductRepository();

  List<FashionItemModel> _fashionProducts = [];
  List<FashionItemModel> get fashionProducts => _fashionProducts;
