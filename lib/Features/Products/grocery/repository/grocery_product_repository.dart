...
class GroceryProductRepository {
  ...
  Future<dynamic> getGroceryProducts(BuildContext context) async {
    try {
      SVProgressHUD.show();
  ...
  Future<dynamic> addGroceryProduct(
      BuildContext context, GroceryItemModel model) async {
    print("inside");
    ...
    try {
      ...
      Map<String, dynamic> data = {
        ...
        "price": model.price,
        "offer_price": model.offerPrice,
        "wholesale_price": model.wholesalePrice,
        "variants": jsonEncode(model.weights),
        "discount": model.discount,
        "is_available": model.available,
        "images": imageFiles,
        "is_popular_product": model.isPopularProduct,
        "is_offer_product": model.isOfferProduct
      };
  ...
  Future<dynamic> deleteGroceryProduct(
  ...
  Future<dynamic> editGroceryProduct(
      BuildContext context, GroceryItemModel model) async {
  ...
  Future<GroceryItemModel?> getGroceryProductDetail(int productId) async {
    try {
