...
class FashionProductEditDeleteScreen extends StatelessWidget {
  final List<FashionItemModel> products;
  const FashionProductEditDeleteScreen({super.key, required this.products});
