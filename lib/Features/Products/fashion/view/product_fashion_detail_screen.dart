...
//                       final ImageUrl =  "$imageUrl${_viewModel.fashionDetail?.colors?[index].colorImage ?? ''}";
//                       return Padding(
...
//                                   border: Border.all(
//                                     width: _colorisSelected==index?1:0
//                                         ,color: FbColors.black
//                                   )
//                                 ),
//                                   child: CachedNetworkImage(
...
//                               ),
//                             SizedBox(height: 5,),
//                             Text('${_viewModel.fashionDetail?.colors?[index].colorName??0}')
//                           ],
//                         ),
//                       );
//                     }),
...
//                     scrollDirection: Axis.horizontal,
//                     itemBuilder: (context, index) {
//                       final sizeUrl=_viewModel.fashionDetail?.colors?.first.sizes?[index].size??"";
//                       return Padding(
